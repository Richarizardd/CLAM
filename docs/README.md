...
ArXiv | [Interactive Demo](http://clam.mahmoodlab.org)

***TL;DR:** CLAM is a high throughput and interpretable method for data efficiant histology whole slide image classification using slide-level labels without any ROI extraction, manual pixel or patch level annotation, capable of handling milti-class subtyping problems. Tested on three different WSI datasets, trained models adapted to independent test cohorts of WSI resections and biopsies as well as cell phone microscopy data.*
